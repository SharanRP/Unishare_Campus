...
const CalendarComponent = () => {
  useEffect(() => {
    const loadCalendarScripts = async () => {
      ...
      await import('https://cdn.jsdelivr.net/npm/evo-calendar@latest/evo-calendar/js/evo-calendar.min.js');
  ...
  useEffect(() => {
    ...
    jqueryScript.onload = () => {
      ...
      evoCalendarScript.src = 'https://cdn.jsdelivr.net/npm/evo-calendar@1.1.3/evo-calendar/js/evo-calendar.min.js';
    ...
              everyYear: true // optional
      ...
      evoCalendarCSS.href = 'https://cdn.jsdelivr.net/npm/evo-calendar@1.1.3/evo-calendar/css/evo-calendar.min.css';
